...
SVTB1= ../env/top.sv
INC = +incdir+../env +incdir+../test +incdir+../write_agent +incdir+../Read_agent
...
run_test1_Questa: sv_cmp
	vsim -cvgperinstance $(VSIMOPT) $(VSIMCOV) $(VSIMBATCH2)  -wlf wave_file2.wlf -l test2.log  -sv_seed 672276567  work.top +UVM_TESTNAME=fixed_test
	vcover report  -cvg  -details -nocompactcrossbins -codeAll -assert -directive -html mem_cov2
	
run_test2_Questa: sv_cmp
	vsim -cvgperinstance $(VSIMOPT) $(VSIMCOV) $(VSIMBATCH3)  -wlf wave_file3.wlf -l test3.log  -sv_seed 399657982  work.top +UVM_TESTNAME=incr_test
...
run_test3_Questa: sv_cmp
	vsim -cvgperinstance $(VSIMOPT) $(VSIMCOV) $(VSIMBATCH4)  -wlf wave_file5.wlf -l test5.log  -sv_seed random  work.top +UVM_TESTNAME=random_test
...
run_test_VCS: clean  sv_cmp_VCS
	./simv -a vcs.log +fsdbfile+wave1.fsdb assert_enable_coverage=1 -cm_dir ./mem_cov1 +ntb_random_seed=3938395258 -assert +UVM_TESTNAME=test
	urg -dir mem_cov1.vdb -format both -report urgReport1
	
run_test1_VCS:clean  sv_cmp_VCS
	./simv -a vcs.log +fsdbfile+wave2.fsdb assert_enable_coverage=1 -cm_dir ./mem_cov2 +ntb_random_seed=3938395258 -assert  +UVM_TESTNAME=fixed_test 
	urg -dir mem_cov2.vdb -format both -report urgReport2
	
run_test2_VCS: clean sv_cmp_VCS
	./simv -a vcs.log +fsdbfile+wave3.fsdb assert_enable_coverage=1 -cm_dir ./mem_cov3 +ntb_random_seed_automatic -assert +UVM_TESTNAME=incr_test 
	urg -dir mem_cov3.vdb -format both -report urgReport3
	
run_test3_VCS:clean  sv_cmp_VCS
	./simv -a vcs.log +fsdbfile+wave4.fsdb assert_enable_coverage=1 -cm_dir ./mem_cov4 +ntb_random_seed_automatic -assert +UVM_TESTNAME=wrap_test 
	urg -dir mem_cov4.vdb -format both -report urgReport4

run_test4_VCS:clean  sv_cmp_VCS
	./simv -a vcs.log +fsdbfile+wave5.fsdb assert_enable_coverage=1 -cm_dir ./mem_cov5 +ntb_random_seed_automatic -assert +UVM_TESTNAME=random_test 
